        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="portlet box blue-madison">
                    ...
                    <div class="portlet-body form">
                        <form class="form-horizontal" role="form" method="post" action="<?php echo  base_url()?>admin/customer/edit/<?php echo $user[0]['id']?>">
                            <input type="hidden" name="password_change" value="0">
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input id="username" class="form-control" type="text" name="username" placeholder="username" value="<?php echo $user[0]['user_name'];?>" <?php echo ($admin->level != 0)? "disabled": "" ?>>
                                            </div>
                                ...
                                <div class="form-group col-sm-6">
                                    <div class="col-sm-6 pull-right">
                                        <?php if ($user[0]['verified_phone'] === '0' && $admin->level == 0):?>
                                            <a class="btn blue-madison col-sm-12" href="<?php echo base_url();?>admin/customer/verify/2/<?php echo $user[0]['id']?>">Activate phone</a>
                                        <?php endif;?>
                                    </div>

                                    <div class="col-sm-6 pull-right">
                                        <?php if ($user[0]['verified_email'] === '0' && $admin->level == 0):?>
                                            <a class="btn blue-madison col-sm-12" href="<?php echo base_url();?>admin/customer/verify/1/<?php echo $user[0]['id']?>">Activate email</a>
                                        <?php endif;?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-6 pull-right">
                                        <?php if ($user[0]['is_activated'] === '0'):?>
                                            <a class="btn blue-madison col-sm-12" href="<?php echo base_url();?>admin/customer/activeuser/<?php echo $user[0]['id']?>">Activate this account</a>
                                        <?php endif;?>
                                        <?php if ($user[0]['is_activated'] === '1'):?>
                                            <a class="btn red-sunglo col-sm-12" href="<?php echo base_url();?>admin/customer/blockuser/<?php echo $user[0]['id']?>">Block this account</a>
                                        <?php endif;?>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="portlet box blue-madison">
                    ...
                    <div class="portlet-body form">
                        <form class="form-horizontal" role="form" id="user_form" method="post" action="<?php echo  base_url()?>admin/customer/password/<?php echo $user[0]['id']?>">
