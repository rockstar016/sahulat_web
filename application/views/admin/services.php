...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            <!-- BEGIN PAGE HEADER-->
            <h3 class="page-title">
                Service team members <small><?php echo count($userlist)?> user(s)</small>
            </h3>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    <li style="margin-top: 8px;">
                        <i class="fa fa-home"></i>
                        <a href="<?php echo base_url()?>admin/service">Home</a>
            ...
            <div class="row">
                <div class="col-md-12 margin-bottom-10">
                    <a href="<?php echo base_url();?>admin/service/create" class="btn blue-madison pull-right">
                        <i class="icon-plus"></i>
                        Add new member
                    </a>
                </div>
                                ...
                                <div class="portlet light">
                                    ...
                                    <div class="row portlet-body">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="col-sm-12">
                                                <a href="<?php echo base_url();?>admin/service/<?php echo $userlist[$i + $j]->id?>" class="btn btn-default bg-blue-madison col-sm-5" >Details</a>
                                                <a href="<?php echo base_url();?>admin/service/edit/<?php echo $userlist[$i + $j]->id?>" class="btn btn-default bg-red-sunglo col-sm-5" >Edit</a>
                                            </div>
...
<script>
    ...
    function onSearchClick(){
        ...
        if(search_value != ""){
            window.location.assign("<?php echo base_url();?>admin/service/search/" + search_value);
        }
        else{
            window.location.assign("<?php echo base_url();?>admin/service");
        }
    }
</script>
<!-- END JAVASCRIPTS -->
